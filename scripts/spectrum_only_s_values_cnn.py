...
def main(
    ...
    cnn_trainer = OnlySpectrumFromSValuesCNN(
    ...
    spectrum = cnn_trainer.predict(test_features)
    sigma_calculator = SpectrumVariationScaler(mean_sigma=mean_sigma, num_channels=283, min_sigma=min_sigma)
