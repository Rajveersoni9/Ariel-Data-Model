...
from ariel_pred.modeling.deep_s_values_cnn_with_star_info import DeepSValuesCNNWithStarInfoTrainer
...
def main(
    ...
    trained_model_folder: str = "../models/s_values_cnn_with_star_info",
    binning: int = 4,
    ...
    predictions = trainer.predict(test_model_data * 1e3, test_star_info) / 1e3
    ...
    predicted_sigma = sigma_calculator.get_sigma(test_data)
